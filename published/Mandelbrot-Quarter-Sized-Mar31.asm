...
# This block of code performs the iterated square
# and add for the value passed in 
...
# This block of code iterates over a grid of complex
# numbers, calling the procedure on line 2 for each
# one. The value returned in AR is printed to the
# typewriter
