...
#Print a CR
                        Load a format code
.59 .  .60.62.5.00.26   Copy next two words to PN
.60   +0000000          
.61   +4400000          
.62 .  .02.63.5.26.03   Copy PN to line 3:02,03

.63 .  .65.65.0.08.31   Output AR to typewriter
.65 .  .65.65.0.28.31   Wait for IOReady

#Replace first value with value from 23:0 and loop
.66 .  .00.67.0.23.28   23:0 -> AR
.67 .  .08.03.0.28.00   AR -> 0:vv
