...
.01   -0147uy1            c=2.5*(10^-2)
.02   +0000000           b=2.5*(10^-2)
.03   -0147uy1            a=1.6*(10^-2)
.04   +0000000           d=0.9*(10^-2)
...
.14 .  .17.15.0.20.28   |Zr| -> AR
.15 .  .17.18.0.08.31   Output AR to typewriter
.18 .  .18.18.0.28.31   Wait for IOReady

.19 .  .21.19.0.16.31   HALT
