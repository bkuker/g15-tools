...
.   .  .L2.L2.0.31.31   NCAR
ml:
#.%1 .  .L1.  .4.28.21   Copy Music data from AR to 21:2 & 3 (DP = Two copies)
.   . u.L5.  .0.28.21   Copy AR to 21:0-4
.   . u.L5.  .0.31.21   Extract parts of notes TODO Choose MAC T
.   .  .03.L2.0.21.25   Load 21:3 to ID TODO MAC
.

.od .  .22.  .1.26.31   Shift ID1 right 10 bits
.   .  .03.  .1.25.21   Copy ID:1 back to 21:3

.   .  .L1.L2.0.00.28   Copy note load instr to AR
.   . u.L3.a1.0.00.00   Note Load Instruction
.   .  .02.  .0.21.29   Add 21:02 to AR TODO MAC
.   .  .L2.L2.0.31.31   NCAR
a1:                     After Note 1

.   .  .L1.L2.0.00.28   Copy note load instr to AR
.   . u.L3.a2.0.00.00   Note Load Instruction
